...
namespace CryptoGuard.MAUI.Views
{
    public partial class FeedPage : ContentPage
    {
        ...
        private void OnFeedFilterChanged(object sender, EventArgs e)
        {
            if (BindingContext is ViewModels.FeedViewModel vm && sender is Picker picker)
            {
                vm.ShowOnlyFollowing = picker.SelectedIndex == 1; // 0: Herkes, 1: Takip Ettiklerim
            }
        }
        ...
        protected override void OnAppearing()
        {
            ...
            {
                _ = vm.LoadFollowingUserIdsAsync();
            }
        }
    }
} 