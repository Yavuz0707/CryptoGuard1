...
namespace CryptoGuard.MAUI.ViewModels
{
    public partial class MainViewModel : BaseViewModel
    {
            ...
            IVoiceRecognitionService voiceRecognitionService)
        {
            ...
            UserPosts = new ObservableCollection<FeedPost>
            {
                new FeedPost { Id = 1, UserId = 1, Content = "Merhaba! Bu benim ilk paylaşımım.", CoinTag = "BTC", CreatedAt = DateTime.Now, User = new User { Username = "burak", ProfilePhoto = "profile_placeholder.png", Email = "burak@example.com", PasswordHash = "dummyhash" }, LikeCount = 2, CommentCount = 1, IsMine = true },
                new FeedPost { Id = 2, UserId = 1, Content = "Ethereum hakkında ne düşünüyorsunuz?", CoinTag = "ETH", CreatedAt = DateTime.Now.AddMinutes(-30), User = new User { Username = "burak", ProfilePhoto = "profile_placeholder.png", Email = "burak@example.com", PasswordHash = "dummyhash" }, LikeCount = 1, CommentCount = 0, IsMine = true }
            };
        }
