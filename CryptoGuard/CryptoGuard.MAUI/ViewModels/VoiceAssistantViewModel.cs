...
namespace CryptoGuard.MAUI.ViewModels
{
    public partial class VoiceAssistantViewModel : ObservableObject
    {
        ...
        {
            { "bitcoin", "90" }, { "btc", "90" }, { "bitkoin", "90" },
            { "ethereum", "80" }, { "eth", "80" }, { "iteryum", "80" }, { "eteryum", "80" },
            { "cosmos", "3077" }, { "atom", "3077" },
            { "dogecoin", "2" }, { "doge", "2" }, { "dogikoyn", "2" }, { "dogikoin", "2" },
            { "solana", "48543" }, { "sol", "48543" }, { "solona", "48543" },
            { "cardano", "257" }, { "ada", "257" },
            { "tether", "518" }, { "usdt", "518" }, { "tezer", "518" },
            { "binance coin", "2710" }, { "bnb", "2710" }, { "binans", "2710" },
            { "xrp", "58" }, { "ekserpi", "58" },
            { "usd coin", "33285" }, { "usdc", "33285" },
            { "tron", "2718" }, { "trx", "2718" },
            { "dogikoyn", "2" }, { "dogikoin", "2" },
            { "staked eth", "18876" }, { "staked eteryum", "18876" },
        };
